...
public final class NetworkManager<EndpointItem: Endpoint> {
    ...
    public func request <T: Decodable>(endpoint: EndpointItem,
                                       type: T.Type, completion: @escaping Completion<T>) {
        AF.request(endpoint.url,
            ...
            .validate()
            .response(responseSerializer: DataResponseSerializer(emptyResponseCodes: possibleEmptyResponseCodes),
